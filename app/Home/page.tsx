    ...
    <div>
      <div className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className=" flex flex-col absolute sm:flex-row items-center justify-center text-white z-10">
          ...
          <div className='flex flex-1 mt-3 md:mt-0 items-center md:items-start flex-col md:ml-48'>
            <h1 className="text-[2.5rem] md:text-7xl md:text-left font-bold md:mb-4 ">Renew, Reuse, Recycle</h1>
            <p className='text-lg text-center md:text-start w-full md:text-2xl md:mt-2'>Discover how your small actions can make a big impact as we work together to reduce waste, conserve resources, and protect our planet for generations to come.</p>
            <div className='mt-6'>
              <Link href='/contact'>
          ...
          <div className="flex-1 flex justify-center md:justify-end p-8 mt-2 md:mt-0 md:mr-60">
            <div className="grid grid-cols-2 gap-y-6 gap-x-1 md:gap-x-48 mt-4 md:mt-0 justify-center items-center">
              <div className="relative w-[200px] h-[160px] sm:w-[240px] sm:h-[200px] md:w-[320px] md:h-[280px] overflow-hidden rounded-xl transform -rotate-12">
                <Image
                  src="/block-1.webp"
                  alt="Styled Image"
                  layout="fill"
              ...
              <div className="relative w-[200px] h-[160px] sm:w-[240px] sm:h-[200px] md:w-[320px] md:h-[280px] overflow-hidden rounded-xl transform rotate-6">
                <Image
                  src="/block-2.webp"
                  alt="Styled Image"
                  layout="fill"
              ...
              <div className="relative w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] md:w-[380px] md:h-[380px] overflow-hidden rounded-xl transform rotate-2">
                <Image
                  src="/block-4.webp"
                  alt="Styled Image"
                  layout="fill"
      ...
      <div className='flex flex-col md:flex-row mt-12 md:mt-48 mb-16 md:mb-48 md:mx-64 justify-center items-center'>
        {/* Left Image */}
        ...
        {/* Right Content */}
        <div className='relative mt-10 mx-6 md:-mt-16 md:mx-10 md:w-1/2'>
          <h1 className='text-3xl md:text-5xl font-semibold text-[#2D3D33]'>Sustainability Is More Than A Goal – It&apos;s Our Mission</h1>
          ...
          <div className='relative flex mt-8 bg-[#2c3b35] rounded-2xl p-6 md:-left-1/4'>
            <div className='flex-1 flex-col items-center text-center'>
              <h1 className='text-4xl md:text-6xl font-medium text-white'>384</h1>
              <p className='text-xl md:text-2xl mt-2 font-normal text-white'>Successful projects</p>
            </div>
            <div className='flex-1 flex-col items-center text-center'>
              <h1 className='text-4xl md:text-6xl font-medium text-white'>1000+</h1>
              <p className='text-xl md:text-2xl mt-2 font-normal text-white'>Satisfied clients</p>
            </div>
            <div className='flex-1 flex-col items-center text-center'>
              <h1 className='text-4xl md:text-6xl font-medium text-white'>20</h1>
              <p className='text-xl md:text-2xl mt-2 font-normal text-white'>Megawatt capacity</p>
            </div>
          </div>
        </div>
      </div>
