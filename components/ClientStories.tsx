...
const ClientCard = ({ avatarSrc, name, role, onClick, isSelected }: ClientProp) => {
    return (
        <div onClick={onClick} className={`cursor-pointer rounded-full border transform duration-300 hover:border-black hover:bg-[#f6f7f9]  ${isSelected ? 'bg-[#f6f7f9] border-black' : 'bg-white'}`}>
